...
#### Labels: Dkk3;A20;Socs1
mouse_up_df = mouse_rat[mouse_rat$Gene.stable.ID %in% c("ENSMUSG00000030772", "ENSMUSG00000019850", "ENSMUSG00000038037"),]
mouse_up_df_uniq = subset(mouse_up_df, !duplicated(mouse_up_df$Gene.stable.ID))
mouse_up_df_uniq$names = c("SOCS1", "A20", "Dkk3")
mouse_up_df_uniq$dnds = mouse_up_df_uniq$dN.with.Rat / mouse_up_df_uniq$dS.with.Rat

#Mouse downstream NFL
#### Labels: Axin2; LATS1; LATS2
mouse_do_df = mouse_rat[mouse_rat$Gene.stable.ID %in% c("ENSMUSG00000000142", "ENSMUSG00000040021", "ENSMUSG00000021959"),]
mouse_do_df_uniq = subset(mouse_do_df, !duplicated(mouse_do_df$Gene.stable.ID))
mouse_do_df_uniq$name = c('Axin2', 'LATS2', 'LATS1')
...
#Zebra upstream NFL
#### Labels: Dkk3; A20; SOCS1
zebra_up_df = zebra_chicken[zebra_chicken$Gene.stable.ID %in% c("ENSTGUG00000016109", "ENSTGUG00000010895", "ENSTGUG00000004867"),]
zebra_up_df_uniq = subset(zebra_up_df, !duplicated(zebra_up_df$Gene.stable.ID))
zebra_up_df_uniq$name  = c("A20", "Dkk3", "SOCS1")
zebra_up_df_uniq$dnds = zebra_up_df_uniq$dN.with.Chicken / zebra_up_df_uniq$dS.with.Chicken


#Zebra downstream NFL
#### Labels: AXIN2; LATS1; LATS2
zebra_do_df = zebra_chicken[zebra_chicken$Gene.stable.ID %in% c("ENSTGUG00000004202", "ENSTGUG00000011347", "ENSTGUG00000011364"),]
zebra_do_df_uniq = subset(zebra_do_df, !duplicated(zebra_do_df$Gene.stable.ID))
zebra_do_df_uniq$name = c('LATS2', 'LATS1', 'AXIN2')
